# Homework
Docker lecture repository at [Avito's Analytics Academy](https://avito-analytics-academy.ru/) Data Science course homework
...
### Step 2. 
Dockerfile uses python version 3.8 as its base image. You can build it by running ```docker build -t=server:0.0.1``` .
...
### Step 6.
You can just run ```docker compose up``` and skip all steps!
